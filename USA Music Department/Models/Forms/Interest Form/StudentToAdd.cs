...
namespace USA_Music_Department.Models.Forms.Interest_Form
{
    public class StudentToAdd
    {
        ...
        [Display(Name = "City")]
        [RegularExpression("[a-zA-Z0-9 ]+", ErrorMessage = "City Name can only contain letters or numbers")]
        ...
        [RegularExpression("[0-9]{5}(?:-[0-9]{4})?", ErrorMessage = "Invalid Zip Ex:99999")]
        public Nullable<int> StudentZipCode { get; set; }

        [Required(ErrorMessage = "Phone Number Required")]
        [Display(Name = "Phone")]
        [DataType(DataType.PhoneNumber)]
        [RegularExpression("([0-9]{3})?[-. ]?([0-9]{3})[-. ]?([0-9]{4})", ErrorMessage = "Not a valid Phone number Ex: 123-456-7890 ")] //Cannot add extended zips due to integer
        ...
        [RegularExpression("([2]{1})([0]{1})([0-9]{2})", ErrorMessage = "Year must be between 2000 - 2099")]
